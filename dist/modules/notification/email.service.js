    ...
    */
    async sendNewUserEmail(userEmail, userName, password, resetToken, expHrs) {
        ...
        const message = `
            ...
            Si tienes alguna pregunta o necesitas más información, puedes consultar los recursos disponibles en la aplicación.
    ...
    */
    async sendUserFinishedEstimation(techManEmail, techManName, userName, proposal) {
        ...
        const message = `
            ...
            Puede acceder a la estimación a través del siguiente link:

            ${process.env.FRONTEND_URL}/dashboard/proposals/workspace/${proposal.id}
           
            Saludos!
        `;
        await this.sendEmail(techManEmail, subject, message);
    }
}
