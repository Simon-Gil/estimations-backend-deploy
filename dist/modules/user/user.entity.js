...
const failed_login_attempt_1 = require("../auth/failed-login-attempt/failed-login-attempt");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => failed_login_attempt_1.FailedLoginAttemptEntity, failedLoginAttempt => failedLoginAttempt.user),
    __metadata("design:type", Array)
