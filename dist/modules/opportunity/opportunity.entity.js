 ...
 *         status:
 *           type: string
 *           enum: [pending, in_progress, won, lost]  # Enum de OpportunityStatus
 ...
 *         account:
 *           type: object
 *           $ref: '#/components/schemas/Account'  # Suponiendo que tienes un esquema Account definido
 *           description: Cuenta asociada a esta oportunidad.
 *         typology:
 *           type: object
 *           $ref: '#/components/schemas/Typology'  # Suponiendo que tienes un esquema Typology definido
 *           description: Tipología asociada a esta oportunidad.
 *         technicalManager:
 *           type: object
 *           $ref: '#/components/schemas/User'  # Suponiendo que tienes un esquema User definido
 *           description: Usuario responsable técnico de esta oportunidad.
 *         commercialManager:
 *           type: object
 *           $ref: '#/components/schemas/User'  # Suponiendo que tienes un esquema User definido
 *           description: Usuario responsable comercial de esta oportunidad.
 *         estimations:
 *           type: array
 *           items:
 *             type: object
 *             $ref: '#/components/schemas/Estimation'  # Suponiendo que tienes un esquema Estimation definido
 *           description: Lista de estimaciones asociadas a esta oportunidad.
 */
