...
async function generateClientFunctional(totalPrice, estimatedMonths, accountName, opportunityName, offerDate, techProposal, goalsAndContext) {
    // Carga de imagenes
    const softUxperienciePath = path_1.default.join(__dirname, '../../../resources/pdf-images/the-software-uxperiencie.png');
    ...
    const duacodeLogoPath = path_1.default.join(__dirname, '../../../resources/pdf-images/duacode-logo.png');
    ...
    const firstPageImagePath = path_1.default.join(__dirname, '../../../resources/pdf-images/first-page-image.png');
    ...
    const backgroundReducedPath = path_1.default.join(__dirname, '../../../resources/pdf-images/reduced-background.png');
    ...
    const teamImagePath = path_1.default.join(__dirname, '../../../resources/pdf-images/team-image.png');
    ...
    const thirdPageImagePath = path_1.default.join(__dirname, '../../../resources/pdf-images/third-page-image.png');
    ...
    const relationsImagePath = path_1.default.join(__dirname, '../../../resources/pdf-images/relations-image.png');
    ...
    const meetingImagePath = path_1.default.join(__dirname, '../../../resources/pdf-images/meeting-room-image.png');
    ...
    const ceoImagePath = path_1.default.join(__dirname, '../../../resources/pdf-images/ceo-image.png');
    ...
    const contenidoHTML = await ejs_1.default.renderFile(path_1.default.join(__dirname, '../../../resources', 'template.ejs'), { sideMargin, softUxperiencieSrc,
        ...
        totalPrice, estimatedMonths, accountName, opportunityName, offerDate, techProposal, goalsAndContext, daysToExp
    });
    // Generación PDF
    ...
    const pdfBuffer = await page.pdf({
        ...
        printBackground: true, // Incluye el fondo en el PDF
        margin: { top: '0px', bottom: '0px', left: '0px', right: '0px' }, // Márgenes
    });
    await browser.close();
    return pdfBuffer;
}
