...
const failed_login_attempt_1 = require("./failed-login-attempt");
class FailedLoginAttemptRepository extends typeorm_1.Repository {
    constructor() {
        super(failed_login_attempt_1.FailedLoginAttemptEntity, database_config_1.default.createEntityManager());
    }
}
