 ...
 *           type: array
 *           items:
 *             $ref: '#/components/schemas/Opportunity'  # Suponiendo que tienes un esquema Opportunity definido
 *           description: Lista de oportunidades asociadas a la cuenta.
 *         priceConfig:
 *           type: object
 *           $ref: '#/components/schemas/PriceConfig'  # Suponiendo que tienes un esquema PriceConfig definido
