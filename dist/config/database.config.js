...
const first_level_category_entity_1 = require("../modules/company-structure/task-categories/first-level-category.entity");
...
const second_level_category_entity_1 = require("../modules/company-structure/task-categories/second-level-category.entity");
...
const failed_login_attempt_1 = require("../modules/auth/failed-login-attempt/failed-login-attempt");
...
const options = {
    ...
    synchronize: true, //process.env.NODE_ENV === 'dev', // Se asigna de forma condicional dependiendo del entorno
    logging: true,
