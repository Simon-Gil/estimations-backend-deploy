...
const SecondLevelCategory_1 = require("../../modules/company-structure/task-categories/SecondLevelCategory");
const second_level_category_entity_1 = require("../../modules/company-structure/task-categories/second-level-category.entity");
const FirstLevelCategory_1 = require("../../modules/company-structure/task-categories/FirstLevelCategory");
...
class TaskCategoriesSeeder {
    async run(dataSource, factoryManager) {
        ...
        await firstLevelRepository.save([
            analisis, desarrollo, gestiones
        ]);
        await secondLevelRepository.save([
