...
class InitSeeder {
    async run(dataSource, factoryManager) {
        await (0, typeorm_extension_1.runSeeders)(dataSource, {
            seeds: [permission_seeder_1.PermissionSeeder, department_seeder_1.DepartmentSeeder, grade_seeder_1.GradeSeeder, role_seeder_1.RoleSeeder, task_categories_seeder_1.TaskCategoriesSeeder, profile_seeder_1.ProfileSeeder, user_seeder_1.UserSeeder, price_config_seeder_1.PriceConfigSeeder, settings_seeder_1.SettingsSeeder],
        });
    }
}
