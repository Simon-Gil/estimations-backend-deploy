...
class RoleSeeder {
    async run(dataSource, factoryManager) {
        ...
        const directorSoftware = new Role_1.Role('Director de Software', software, director, [
            ...
            find('assignNewTypology', 'opportunity'), find('update', 'opportunity'), find('assignTechnicalManager', 'opportunity'),
        ...
        const coordinadorSoftware = new Role_1.Role('Coordinador de Software', software, coordinador, [
            ...
            find('read', 'opportunity'), find('manageDocument', 'opportunity'), find('assignNewTypology', 'opportunity'),
        ...
        console.log('Datos default de roles introducidos');
    }
}
