 ...
 * tags:
 *   - name: Documents
 *     description: Endpoints relacionados con la gestión de documentos y almacenamiento
 */
/**
 * @swagger
 ...
 *     description: Obtiene una URL firmada de carga para un archivo, permitiendo la carga segura en el proveedor de almacenamiento configurado.
 *     tags: [Documents]
 *     security:
 ...
 *     description: Obtiene una URL firmada de descarga para un archivo, permitiendo la descarga segura desde el proveedor de almacenamiento configurado.
 *     tags: [Documents]
 *     security:
 *       - bearerAuth: []  # Requiere autenticación
 *     parameters:
 ...
 *   get:
 *     summary: Verifica si un archivo existe en S3
 *     description: Verifica si un archivo específico ya existe en el almacenamiento configurado para la oportunidad, usando el nombre y el tipo del archivo como parámetros de consulta.
 *     tags: [Documents]
 *     security:
 *       - bearerAuth: []  # Requiere autenticación
 *     parameters:
 ...
 *   post:
 *     summary: Genera una URL firmada para eliminar un archivo en S3
 *     description: Genera una URL firmada temporal que permite la eliminación de un archivo específico almacenado en S3 asociado con una oportunidad.
 *     tags: [Documents]
 *     security:
 *       - bearerAuth: []  # Requiere autenticación
 *     parameters:
